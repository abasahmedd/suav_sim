...
from sim_math.rotation import ned2xyz, rot_matrix_zyx
from DataDisplay.panel_components import View
...
class AttitudeView(View):
    ...
    def _setup_aircraft_model(self):
        ...
        self.ax.set_title("Attitude Visualization", fontname="Times New Roman")
        self.ax.set_xlabel("East (m)")
        self.ax.set_ylabel("North (m)")
        self.ax.set_zlabel("Height (m)")
        self.ax.set_xlim(-0.9 * UAV_SPAN, 0.9 * UAV_SPAN)
        self.ax.set_ylim(-0.9 * UAV_SPAN, 0.9 * UAV_SPAN)
        self.ax.set_zlim(-0.9 * UAV_SPAN, 0.9 * UAV_SPAN)
        ...
        self.poly.set_facecolors(["#d9d9d9", "#4f81bd", "#4f81bd", "#6b6b6b"])
        self.poly.set_edgecolor("k")
        self.poly.set_alpha(0.95)
