...
if __package__ in (None, ""):
    ...
    from chapter3.estimation.state_estimation_filter import (
        EstimatedState,
    ...
    from sim_math.angles import wrap_angle_2pi
else:
...
class ModelInversionFilter(StateEstimationFilter):
    ...
    def update(self, readings: SensorReadings) -> EstimatedState:
        ...
        # --- Barometer & AirspeedSensor: estimate altitude and airspeed ---
        ...
        # --- MagnetometerCompass: estimate yaw/heading ---
        heading = self._estimate_heading_from_compass(readings.compass.data.item())

        # --- GlobalPositioningSystem: estimate position and ground velocity/course ---
    ...
    def _estimate_altitude_airspeed(
        ...
        # AirspeedSensor: dynamic pressure to velocity
    ...
    def _estimate_gps(
        ...
        """
        Estimate filtered position, ground speed, and course from GlobalPositioningSystem.
