...
class ExtendedKalmanFilter:
    """Extended Kalman Filter (ExtendedKalmanFilter) for nonlinear systems.
    ...
    The ExtendedKalmanFilter linearizes the nonlinear functions around the current state estimate
    ...
    def predict(self, u: np.ndarray) -> np.ndarray:
        """Perform the ExtendedKalmanFilter prediction (time update) step.
    ...
    def update(self, z: np.ndarray, u: np.ndarray) -> np.ndarray:
        """Perform the ExtendedKalmanFilter measurement update (correction step).
