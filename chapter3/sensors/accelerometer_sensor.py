...
from chapter3.sensors.noise_models import get_white_noise
from chapter3.sensors.signal_simulation import saturate, digitalize
...
class Accelerometer(Sensor):
    ...
    def __init__(
        self, params: AccelParams, state: AircraftStates, name: str = "acc"
    ) -> None:
        super().__init__(
            params,
            state,
