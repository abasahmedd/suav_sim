...
from sim_math.angles import wrap_angle
from sim_math.rotation import rot_matrix_zyx
...
class LinePathFollower(BasePathFollower):
    ...
    def __init__(self, config: AutopilotDesignParameters) -> None:
        """
        Initialize the StraightLinePathFollowing with autopilot configuration.
