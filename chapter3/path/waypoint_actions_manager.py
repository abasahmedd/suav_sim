...
from chapter3.path.path_guidance import OrbitPathParams
from chapter3.path.navigation_algorithms import PathNavCommand
...
class WaypointActionsManager:
    ...
    Attributes
    ----------
    route_manager : WaypointManagement
    ...
    def __init__(self, route_manager: WaypointManagement, flight_cmd: FlightCommand) -> None:
        """
