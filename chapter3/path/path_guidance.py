...
from chapter3.path.base_path_following_algorithm import BasePathFollower, BasePathParams
from chapter3.path.straight_line_path_following import LinePathFollower, LinePathParams
from chapter3.path.circular_orbit_path_following import OrbitPathFollower, OrbitPathParams
...
class PathGuidance:
    ...
    def follow_orbit(self, orbit_params: OrbitPathParams) -> None:
        ...
        self.active_follower_info = (
            ...
            f"Direction: {'CW' if orbit_params.direction > 0 else 'CCW'}"
        )
        self.active_follower_status = "initialized"
