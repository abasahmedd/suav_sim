...
class WaypointManagement:
    def __init__(self, config: AutopilotDesignParameters = None) -> None:
        """
        Initialize the WaypointManagement.

        Parameters
        ----------
        config : AutopilotDesignParameters, optional
            Configuration parameters for the autopilot, by default None.
        """
        self.config = config or AutopilotDesignParameters()
