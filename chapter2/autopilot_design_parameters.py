...
from DataDisplay.constants import EARTH_GRAVITY_CONSTANT as g
from sim_math.numeric_differentiation import jacobian


@dataclass
class AutopilotDesignParameters:
    ...
    # design parameters
    BW_course = 10.0  # wn_course = wn_roll / BW_course = 5 / 10 = 0.5
    zeta_course = 0.707
    # computed gains
    kp_course_roll = 0.0
    ki_course_roll = 0.0
    ...
    # design parameters
    BW_altitude = 20.0  # wn_altitude = wn_pitch / BW_altitude = 20 / 20 = 1.0
    zeta_altitude = 0.707
    # computed gains
    ...
    def calculate_control_gains(
        ...
        deltas_trim: ControlDeflections,
    ) -> None:
        """
    ...
    def _calculate_roll_gains(
        self, params: AirframeParameters, state_trim: AircraftStates
    ) -> None:
    ...
    def _calculate_course_gains(self, state_trim: AircraftStates) -> None:
    ...
    def _calculate_altitude_gains(self, state_trim: AircraftStates) -> None:
        Va_trim = state_trim.airspeed
    ...
    def _calculate_airspeed_gains(
        ...
        Va_trim = state_trim.airspeed
        # Propulsion Model
        prop_model = PropulsionForcesMoments(params)
