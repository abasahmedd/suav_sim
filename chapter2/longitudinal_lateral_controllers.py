...
from chapter2.pid_controller import PIDController
...
class LongitudinalLateralControl:

    def __init__(self, config: AutopilotDesignParameters) -> None:
        """
        Initialize the LongitudinalLateralControl with the given autopilot configuration.
