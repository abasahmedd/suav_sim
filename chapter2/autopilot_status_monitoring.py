...
from chapter3.path.path_guidance import PathGuidance
from chapter3.path.mission_management import MissionManagement
from sim_math.angles import diff_angle_pi


@dataclass
class AutopilotStatusMonitoring:
    """
    ...
    def update_aircraft_state(self, state: AircraftStates) -> None:
        """
    ...
    # def update_path_follower(self, path_follower: PathGuidance) -> None:
    ...
    def __str__(self) -> str:
        ...
        return (
            ...
            f"- AirspeedSensor: {self.airspeed:.2f} m/s, Target AirspeedSensor: {self.target_airspeed:.2f} m/s, Error: {self.airspeed_error:.2f} m/s"
        )
