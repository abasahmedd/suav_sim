...
from sim_math.kinematics import euler_kinematics
from sim_math.rotation import (
    euler2quat,
    quat2euler,
    rot_matrix_quat,
    rot_matrix_wind,
...
class AircraftStates:
    def __init__(
        ...
        """
        Initialize the AircraftStates class.
        ...
        - pd: Position Down (meters) -- height 
