...
class AerodynamicForcesMoments:
    ...
    def calculate_forces_moments(
        self, state: AircraftStates, deltas: ControlDeflections
    ) -> np.ndarray:
        """
    ...
    def lift_force(self, state: AircraftStates, deltas: ControlDeflections) -> float:
        """
    ...
    def drag_force(self, state: AircraftStates, deltas: ControlDeflections) -> float:
        """
    ...
    def pitch_moment(self, state: AircraftStates, deltas: ControlDeflections) -> float:
        """
    ...
    def lateral_force(self, state: AircraftStates, deltas: ControlDeflections) -> float:
        """
    ...
    def roll_moment(self, state: AircraftStates, deltas: ControlDeflections) -> float:
        """
    ...
    def yaw_moment(self, state: AircraftStates, deltas: ControlDeflections) -> float:
