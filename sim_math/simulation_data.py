...
from chapter2.complete_autopilot_system import AutopilotStatusMonitoring
...
class SimulationData:
    ...
    t_sim: float
    k_sim: int
    uav_state: AircraftStates
    control_deflections: ControlDeflections
    autopilot_status: AutopilotStatusMonitoring
    mission_control: MissionManagement
